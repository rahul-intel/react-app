                                            ...
                                            <div className="row m-l-0 m-r-0">
                                                <div className="col-sm-4 bg-c-lite-green user-profile">
                                                    <div className="card-block text-center text-white">
                                                        ...
                                                        {
                                                            dashboardData?.photo ? <img src="dashboardData?.photo" className="img-radius" alt="User-Profile" /> :
                                                ...
                                                <div className="card-block">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-sm-6">
                                                            ...
                                                            <h6 className="text-muted f-w-400">{dashboardData?.github}</h6>
                                                        </div>
                                                        <div className="col-sm-6">
                                                            <p className="m-b-10 f-w-600">Stack Overflow</p>
                                                            <h6 className="text-muted f-w-400">{dashboardData?.stackoverflow}</h6>
                                                        </div>
                                                    </div>
                                                    {/* <ul className="social-link list-unstyled m-t-40 m-b-10">
                                                        <li><a href="#!" ><i className="mdi mdi-facebook feather icon-facebook facebook" aria-hidden="true"></i></a></li>
                                                        <li><a href="#!"><i className="mdi mdi-twitter feather icon-twitter twitter" aria-hidden="true"></i></a></li>
                                                        <li><a href="#!"><i className="mdi mdi-instagram feather icon-instagram instagram" aria-hidden="true"></i></a></li>
                                                    </ul> */}
                                                </div>
                                            </div>
                                            </div>
